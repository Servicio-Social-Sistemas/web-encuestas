...
import Markers from "./Markers"; // Asegúrate de proporcionar l // Asegúrate de proporcionar la ruta correcta
import BarChart from "./ResponseChart";

const MapComponent = ({ selectedQuestion, surveyId }) => {
